...
extension UIColor {
    ...
    class var mineLoverBlack: UIColor {
        return UIColor(hex: 0x1B1B1B)
    }
    class var mineLoverLightBlack: UIColor {
        return UIColor(hex: 0x282828)
    }
    class var mineLoverBlackBG: UIColor {
        return UIColor(hex: 0x000000, alpha: 0.8)
    }
    class var mineLoverGrey: UIColor {
        return UIColor(hex: 0x5D5D5D)
    }
    class var mineLoverDarkGreen: UIColor{
        return UIColor(hex: 0x1C9500)
    }
    class var mineLoverLightGreen: UIColor{
        return UIColor(hex: 0x40BD23)
    }
    class var diceRollerLightBlue: UIColor{
        return UIColor(hex: 0x00E0C3)
    }
    class var TFRed: UIColor{
        return UIColor(hex: 0xCE2B2F)
    }
    class var TFLightBlack: UIColor{
        return UIColor(hex: 0x252525)
    }
    class var TFButtonText: UIColor{
        return UIColor(hex: 0xDDDDDD)
    }
    class var TFBlackHover: UIColor{
        return UIColor(hex: 0x000000, alpha: 0.1)
    }
